...
const commissionFormSchema = z.object({
  ...
  upfront_payment_date: z.date().optional().nullable(),
...
export const CommissionEditForm: React.FC<CommissionEditFormProps> = ({ 
  commission, 
  onClose 
}) => {
  ...
  const form = useForm<CommissionFormValues>({
    ...
    defaultValues: {
      upfront_amount: commission.upfront_amount,
      upfront_payment_date: commission.upfront_payment_date ? new Date(commission.upfront_payment_date) : null,
      trail_percentage: commission.trail_percentage,
      trail_amount: commission.trail_amount,
    ...
    try {
      await updateCommission({
        ...
        data: {
          ...
          upfront_payment_date: values.upfront_payment_date ? values.upfront_payment_date.toISOString() : null,
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-6 py-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Trail Amount</FormLabel>
                <FormControl>
                  <Input
                    type="number"
                    placeholder="e.g. 100"
